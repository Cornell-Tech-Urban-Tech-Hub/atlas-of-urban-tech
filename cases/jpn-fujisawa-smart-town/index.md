...
- [**Fujisawa SST - Hard System**](./Fujisawa_hard_system.pdf): Highlights include a solar-powered energy network with SMARTHEMS™ integration and a transportation system featuring rentable EVs and bikes, alongside the "virtual gated town" concept for safety and surveillance.

- [**Fujisawa SST - Soft System**](./Fujisawa_soft_system.pdf): Fujisawa Sustainable Smart Town (SST) is a joint initiative between Panasonic and the government with a 100-year vision, featuring community energy systems, autonomous transport, wellness initiatives, and human-centered governance.

- [**Fujisawa SST - Emergent Urban Dynamics**](./Fujisawa_final.pdf): Focused on Fujisawa SST's response to Japan's aging population, the project emphasizes elderly care, energy systems, and community involvement, while also exploring global smart city trends and comparisons.
