...
layout: case
author: Ka Wing Lui
name:  Cardiff’s Smart City Roadmap
city: Cardiff
...
## Key Characteristics
- pick any 3 characteristics from new city framekwork and describe, 50 words each. digital master plan - development, engagement, etc
...
- shoot for 3, 50 words, what the project is trying to do. come up with title to replace goal 1, goal 2 ...
...
## Stakeholders
<!--  Identify 3-5 key stakeholder organizations or groups. The text should be around 50 words, and include a link to the organization.---> shall be orginizations or group of people.
...
## Leadership
<!--  Conduct one interview with a project leader, and link to a LinkedIn or other profile. Provide a brief biography, no more than 75 words. Identify 3-5 insights or themes from the interview. Feel free to add a photo of the individual here. ---> report interview, interview high points.
