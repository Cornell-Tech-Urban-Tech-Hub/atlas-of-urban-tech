...
[INFO 5410, Urban Systems](https://classes.cornell.edu/browse/roster/FA24/class/INFO/5410) is an introductory course at Cornell Tech, taught by [Michael Samuelian](https://tech.cornell.edu/people/michael-m-samuelian/) that provides an overview of the key systems and processes of cities. It is one of the foundational courses of the [Urban Tech concentration](https://tech.cornell.edu/programs/masters-programs/jacobs-technion-cornell-dual-ms-urban-tech/) in the Jacobs Technion-Cornell Dual Master of Science Degree program.

As part of this course, students analyze the urban system architecture, including its networks, flows, nodes and agents, drawing on the Atlas of Urban Tech as source material. Student projects related to this case include:

- [Title A](link A): Two sentence summary of the PDF generated by AI.
