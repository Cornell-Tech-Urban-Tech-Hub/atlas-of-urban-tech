...
- [**Amsterdam - Hard System**](./Amsterdam_hard.pdf): Explores Amsterdam's physical infrastructure, including its water system, extensive bike paths, and housing layout, emphasizing sustainability and urban planning. Key highlights include advanced water management nodes, cycling networks with dedicated paths, and strategies to address bike theft and parking challenges.

- [**Amsterdam - Soft System**](./Amsterdam_soft.pdf): Highlights Amsterdam's cultural shift toward sustainability, featuring initiatives like CycleSpace, Plastic Whale, and Peerby, which foster community engagement. Emphasizes a flat social structure, accessible healthcare systems, and a culture of open data sharing supported by digital technologies.

- [**Amsterdam - Emergent Urban Dynamics**](./Amsterdam_final.pdf): Focuses on the evolution of Amsterdam's sustainability ethos, from renewable energy adoption to sustainable transportation and building innovations. Key topics include blue-green roofs, the city's cycling infrastructure, and efforts to balance tourism with local quality of life.
